...
class CommandRegistrar
{
    ...
    public static function register()
    {
        ...
        \WP_CLI::add_command("routes:help", HelpCommand::class);

        // Register controller commands
        \WP_CLI::add_command(
            "routes:make-controller",
            ControllerCommand::class,
        );
        \WP_CLI::add_command("routes:controller-list", [
            ControllerCommand::class,
            "listControllers",
        ]);
        ...
        \WP_CLI::add_command(
            "routes:make-middleware",
            MiddlewareCommand::class,
        );
        \WP_CLI::add_command("routes:middleware-list", [
            MiddlewareCommand::class,
            "listMiddleware",
        ]);

        // Register route commands
        \WP_CLI::add_command("routes:list", [
            ControllerCommand::class,
            "listRoutes",
        ]);
        \WP_CLI::add_command("routes:flush", [
            ControllerCommand::class,
            "flushRoutes",
        ]);
        \WP_CLI::add_command("routes:debug", [
            ControllerCommand::class,
            "debugRoutes",
        ]);
    }
