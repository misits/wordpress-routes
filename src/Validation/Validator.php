...
class Validator
{
    ...
    protected function getDefaultMessage($attribute, $rule, $parameters = [])
    {
        $messages = [
            ...
            'accepted_if' => "The {$attribute} field must be accepted when {$parameters[0]} is {$parameters[1]}.",
            'after' => "The {$attribute} field must be a date after {$parameters[0]}.",
            'after_or_equal' => "The {$attribute} field must be a date after or equal to {$parameters[0]}.",
            ...
            'before' => "The {$attribute} field must be a date before {$parameters[0]}.",
            'before_or_equal' => "The {$attribute} field must be a date before or equal to {$parameters[0]}.",
            'between' => "The {$attribute} field must be between {$parameters[0]} and {$parameters[1]}.",
            'boolean' => "The {$attribute} field must be true or false.",
            'confirmed' => "The {$attribute} field confirmation does not match.",
            'date' => "The {$attribute} field must be a valid date.",
            'date_equals' => "The {$attribute} field must be a date equal to {$parameters[0]}.",
            'date_format' => "The {$attribute} field must match the format {$parameters[0]}.",
            'decimal' => "The {$attribute} field must have {$parameters[0]} decimal places.",
            'declined' => "The {$attribute} field must be declined.",
            'declined_if' => "The {$attribute} field must be declined when {$parameters[0]} is {$parameters[1]}.",
            'different' => "The {$attribute} field and {$parameters[0]} must be different.",
            'digits' => "The {$attribute} field must be {$parameters[0]} digits.",
            'digits_between' => "The {$attribute} field must be between {$parameters[0]} and {$parameters[1]} digits.",
            ...
            'gt' => "The {$attribute} field must be greater than {$parameters[0]}.",
            'gte' => "The {$attribute} field must be greater than or equal to {$parameters[0]}.",
            'image' => "The {$attribute} field must be an image.",
            'in' => "The selected {$attribute} is invalid.",
            'in_array' => "The {$attribute} field does not exist in {$parameters[0]}.",
            ...
            'lt' => "The {$attribute} field must be less than {$parameters[0]}.",
            'lte' => "The {$attribute} field must be less than or equal to {$parameters[0]}.",
            'max' => "The {$attribute} field must not be greater than {$parameters[0]}.",
            'mimes' => "The {$attribute} field must be a file of type: " . implode(', ', $parameters),
            'min' => "The {$attribute} field must be at least {$parameters[0]}.",
            'multiple_of' => "The {$attribute} field must be a multiple of {$parameters[0]}.",
            ...
            'required_if' => "The {$attribute} field is required when {$parameters[0]} is {$parameters[1]}.",
            'required_unless' => "The {$attribute} field is required unless {$parameters[0]} is in " . implode(', ', array_slice($parameters, 1)),
            ...
            'same' => "The {$attribute} field and {$parameters[0]} must match.",
            'size' => "The {$attribute} field must be {$parameters[0]}.",
